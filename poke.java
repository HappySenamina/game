...
public class poke extends JFrame{
	...
	public class MyJPanel extends JPanel implements ActionListener, MouseListener{
		...
		public MyJPanel(){
			...
			ImageIcon icon = new ImageIcon("mizuo.jpg");
			image1 = icon.getImage();
			
			ImageIcon icon2 = new ImageIcon("yoshi.jpg");
			image2 = icon2.getImage();
			
			ImageIcon icon3 = new ImageIcon("bakuha.jpg");
			image3 = icon3.getImage();
			
			ImageIcon icon4 = new ImageIcon("ball.jpg");
			image4 = icon4.getImage();
			
			ImageIcon icon5 = new ImageIcon("yoshihara.jpg");
		...
		public void paintComponent(Graphics g){
			...
			if((stage!=1)&&(stage!=2)&&(stage!=-1)&&(stage!=0)&&(stage!=-100)){
				...
				g.drawString("♂ラボ畜　偏差値.100",700,300);
				...
				g.setColor(Color.black);
				g.setFont(new Font(Font.SERIF,Font.BOLD,20));
				g.drawString("♂瑞生君　偏差値.100",350,500);
			}
			...
			if(stage==2){
				...
				g.drawString("あ、吉原がラボから飛び出してきた",90,600);
				sec++;
				if(sec>300){
					stage=3;
					sec=0;
			...
			if(stage==5){//つかまえる
				...
				g.setColor(Color.black);
				g.setFont(new Font(Font.SERIF,Font.BOLD,30));
				g.drawString("瑞生君はモンスターボールを使った",90,600);
				sec++;
				if((sec>150)&&(sec<170)){
					ball_x=70;
					ball_y=550;
				...
				g.setFont(new Font(Font.SERIF,Font.BOLD,30));
						g.drawString("おめでとう！ラボ畜をゲットした",90,600);
					
				}
				if((green_samashi>50)&&(sec>700)){
					stage=3;
					sec=0;
				}
				if((green_samashi<50)&&(sec>700)){
			...
			if(stage==6){//にげる
				...
				g.setColor(Color.black);
				g.setFont(new Font(Font.SERIF,Font.BOLD,30));
				g.drawString("ラボ畜はラボに戻ろうとしない",90,600);
			...
			if(stage==42){//エアスラッシュ
				...
				g.setColor(Color.black);
				g.setFont(new Font(Font.SERIF,Font.BOLD,30));
				g.drawString("瑞生君のエアスラッシュ",90,600);
				sec++;
				if((sec>200)&&(sec<300)){
					my_x+=10;
					my_y-=10;
			...
			if(stage==44){//はかいこうせん
				...
				g.setColor(Color.black);
				g.setFont(new Font(Font.SERIF,Font.BOLD,30));
				g.drawString("瑞生君のはかいこうせん",90,600);
				sec++;
				if((sec>200)&&(sec<250)){
					bakuha_x=70;
					bakuha_y=550;
